...
// function return_formatted_teuchos_array_values
...
{
    XMLGen::set_value_keyword_to_ignore_if_empty(const_cast<std::vector<std::string>&>(aValues));
    XMLGen::append_parameter_plus_attributes(aKeys, aValues, aParentNode);
}
// function append_key_value_pairs_to_node
